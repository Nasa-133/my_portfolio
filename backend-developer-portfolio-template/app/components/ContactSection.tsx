						...
						<div className="font-mono">
							...
							<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
								<motion.a
									...
									className="flex items-center justify-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
								...
								<motion.a
									href="/MUHAMMADSIDDIQ_MURODJONOV_CV.pdf"
									download="MUHAMMADSIDDIQ_MURODJONOV_CV.pdf"
									whileHover={{ scale: 1.05 }}
									className="flex items-center justify-center gap-3 px-4 py-3 bg-blue-500/20 rounded-lg hover:bg-blue-500/30 transition-colors border border-blue-500/30 group"
								>
									<svg className="w-5 h-5 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
									</svg>
									<p className="font-semibold text-gray-200">Download CV</p>
								</motion.a>
							</div>
						</div>
					</div>
